...
const DetailStory = () => {
  ...
  useEffect(() => {
    ...
    const getDetailStory = async () => {
      ...
      var activeUser = {}
      try {
        const { data } = await axios.get(`${server}auth/private`, {
          headers: {
      ...
      try {
        const { data } = await axios.post(`${server}story/${slug}`, { activeUser })
        setStory(data.data)
  ...
  const handleLike = async () => {
    ...
    try {
      const { data } = await axios.post(`${server}story/${slug}/like`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
  ...
  const handleDelete = async () => {
    ...
    if (window.confirm("Do you want to delete this post")) {
      ...
      try {
        ...
        await axios.delete(`${server}story/${slug}/delete`, {
          headers: {
            "Content-Type": "application/json",
            authorization: `Bearer ${localStorage.getItem("authToken")}`,
          },
  ...
  const addStoryToReadList = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(`${server}user/${slug}/addStoryToReadList`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
            ...
            <div className='Inclusive-detailStory-page'>
                  ...
                  <ul>
                    {story.author &&
                      <li className='story-author-info'>
                        <img src={`${server}userPhotos/${story.author.photo}`} alt={story.author.username} />
              ...
              <div className='story-content' >
                ...
                <div className="story-banner-img">
                  <img src={`${server}storyImages/${story.image}`} alt={story.title} />
